...
train = read.csv("C:\\Users\\User\\github\\data\\TFTLCD\\train_2.csv", fileEncoding = 'CP949') # train
test = read.csv("C:\\Users\\User\\github\\data\\TFTLCD\\test_2.csv", fileEncoding = 'CP949') # test
